...
import { FoodHistoryRow } from '@/components/home/FoodHistoryRow';
...
import {
  calculateBabyAge, DiaperAlert, FoodSummary, MEAL_TONE, MealKind,
  formatClock, formatRelative, getEntryDetail, getEntryDisplayLabel,
  getDiaperHealthAlerts, getFoodAllergyAlerts, getFoodSummary, getFoodTodayCount,
  getHourPeriod, getLastFood, getMealKind, getPinnedVaccines, getWeightMeasurements,
  hoursSince, localeTag,
