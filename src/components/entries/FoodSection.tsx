...
const styles = StyleSheet.create({
  ...
  presetPill: { flexDirection: 'row', alignItems: 'center', gap: 5, paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, borderWidth: 1, minHeight: 44 },
  presetLabel: { fontSize: 12, fontWeight: '600' },
  recentRow: { flexDirection: 'row', flexWrap: 'wrap', gap: 6, marginTop: 8 },
  recentChip: { paddingHorizontal: 12, paddingVertical: 8, borderRadius: 999, borderWidth: 1, minHeight: 44, justifyContent: 'center' },
