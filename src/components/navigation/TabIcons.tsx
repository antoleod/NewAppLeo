...
export function HomeTabIcon({ color, size = 24, focused }: Props) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M4.2 12.5C4.2 8.3 7.6 4.9 11.9 4.9C16.3 4.9 19.8 8.3 19.8 12.5C19.8 16.9 16.3 20.4 12 20.4C7.7 20.4 4.2 16.9 4.2 12.5Z" stroke={color} strokeWidth={s} fill={focused ? color : 'none'} fillOpacity={0.1} />
      <Path d="M7.4 14.4C9.1 16.5 12.4 17.2 16.6 14.4" stroke={color} strokeWidth={s} strokeLinecap="round" fill="none" />
      <Path d="M12 7.4C12 7.4 9.6 10.5 9.6 12.4C9.6 13.9 10.7 15 12 15C13.3 15 14.4 13.9 14.4 12.4C14.4 10.5 12 7.4 12 7.4Z" fill={color} fillOpacity={focused ? 0.95 : 0.32} />
      <Path d="M8.8 5.2C9.4 3.9 10.6 3.2 12 3.2C13.4 3.2 14.6 3.9 15.2 5.2" stroke={color} strokeWidth={1.4} strokeLinecap="round" opacity={0.72} />
    </Svg>
  );
}
...
export function HistoryTabIcon({ color, size = 24, focused }: Props) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Path d="M12 4.5Q8.5 3.5 5.5 4.5Q4.5 5 4.5 6V18.5Q4.5 19.5 5.5 19.5Q8.5 20.5 12 19.5V4.5Z" stroke={color} strokeWidth={s} strokeLinejoin="round" fill={focused ? color : 'none'} fillOpacity={0.08} />
      <Path d="M12 4.5Q15.5 3.5 18.5 4.5Q19.5 5 19.5 6V18.5Q19.5 19.5 18.5 19.5Q15.5 20.5 12 19.5V4.5Z" stroke={color} strokeWidth={s} strokeLinejoin="round" fill={focused ? color : 'none'} fillOpacity={0.08} />
      <Line x1={12} y1={4.5} x2={12} y2={19.5} stroke={color} strokeWidth={s} strokeLinecap="round" />
      <Path d="M15.2 8.2H17.8V15.1L16.5 13.9L15.2 15.1Z" fill={color} fillOpacity={focused ? 1 : 0.62} />
...
export function InsightsTabIcon({ color, size = 24, focused }: Props) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Rect x={2} y={14} width={4.5} height={8} rx={1.3} stroke={color} strokeWidth={s} fill={focused ? color : 'none'} fillOpacity={0.15} />
      <Rect x={9.75} y={9.5} width={4.5} height={12.5} rx={1.3} stroke={color} strokeWidth={s} fill={focused ? color : 'none'} fillOpacity={0.15} />
      <Rect x={17.5} y={5} width={4.5} height={17} rx={1.3} stroke={color} strokeWidth={s} fill={focused ? color : 'none'} fillOpacity={0.15} />
...
export function ProfileTabIcon({ color, size = 24, focused }: Props) {
  ...
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" fill="none">
      <Circle cx={12} cy={10} r={7} stroke={color} strokeWidth={s} fill={focused ? color : 'none'} fillOpacity={0.12} />
      <Path d="M5 9.5Q3.2 10 3.2 11Q3.2 12 5 12.5" stroke={color} strokeWidth={s} strokeLinecap="round" fill="none" />
      <Path d="M19 9.5Q20.8 10 20.8 11Q20.8 12 19 12.5" stroke={color} strokeWidth={s} strokeLinecap="round" fill="none" />
      ...
      <Path d="M5 22.5Q5 18.5 12 18.5Q19 18.5 19 22.5" stroke={color} strokeWidth={s} strokeLinecap="round" fill="none" />
    </Svg>
  );
}
